...
# CUDA BASE (adapted from https://gitlab.com/nvidia/container-images/cuda/-/blob/master/dist/11.8.0/ubuntu2004/base/Dockerfile)
ENV NVARCH=x86_64
...
# CUDA RUNTIME (adapted from https://gitlab.com/nvidia/container-images/cuda/-/blob/master/dist/11.8.0/ubuntu2004/runtime/Dockerfile)
